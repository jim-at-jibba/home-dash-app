...
export type MutationCreateRecipeFromBbcArgs = {
  input: CreateBbcRecipeInput
}
...
export type Query = {
  ...
  getFoodCategories: Array<FoodCategories>
...
export type RecipeFull = {
  ...
  prepTime: Scalars["Float"]
  serves: Scalars["Float"]
  recipeUrl?: Maybe<Scalars["String"]>
  createdAt: Scalars["DateTime"]
  updatedAt: Scalars["DateTime"]
}
...
export type GetFoodCategoriesQuery = {__typename?: "Query"} & {
  getFoodCategories: Array<
    {__typename?: "FoodCategories"} & Pick<
      FoodCategories,
      "id" | "name" | "createdAt" | "updatedAt"
    >
  >
...
export type GetFoodCoursesQuery = {__typename?: "Query"} & {
  getFoodCourses: Array<
    {__typename?: "FoodCourses"} & Pick<FoodCourses, "id" | "name" | "createdAt" | "updatedAt">
  >
}
...
export type GetRecipeByIdQuery = {__typename?: "Query"} & {
  getRecipeById: {__typename?: "RecipeFull"} & Pick<
    RecipeFull,
    | "id"
    | "name"
    | "course"
  ...
  > & {
      ...
      >
      ingredients: Array<
        {__typename?: "RecipeIngredients"} & Pick<RecipeIngredients, "id" | "ingredient">
      >
    }
}
...
export type CreateRecipeMutation = {__typename?: "Mutation"} & {
  createRecipe: {__typename?: "RecipeFull"} & Pick<
    RecipeFull,
    | "id"
    | "name"
    | "course"
...
export type CreateBbcRecipeMutationVariables = Exact<{
  input: CreateBbcRecipeInput
}>

export type CreateBbcRecipeMutation = {__typename?: "Mutation"} & {
  createRecipeFromBBC: {__typename?: "CreateRecipeOutput"} & Pick<CreateRecipeOutput, "id">
}
 ...
 * });
 */
export function useGetFoodCategoriesQuery(
  baseOptions?: Apollo.QueryHookOptions<GetFoodCategoriesQuery, GetFoodCategoriesQueryVariables>,
) {
  const options = {...defaultOptions, ...baseOptions}
  return Apollo.useQuery<GetFoodCategoriesQuery, GetFoodCategoriesQueryVariables>(
    GetFoodCategoriesDocument,
    options,
  )
}
export function useGetFoodCategoriesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
  ...
  const options = {...defaultOptions, ...baseOptions}
  return Apollo.useLazyQuery<GetFoodCategoriesQuery, GetFoodCategoriesQueryVariables>(
    GetFoodCategoriesDocument,
    options,
  )
}
...
export type GetFoodCategoriesQueryResult = Apollo.QueryResult<
  GetFoodCategoriesQuery,
  GetFoodCategoriesQueryVariables
>
 ...
 * });
 */
export function useGetFoodCoursesQuery(
  baseOptions?: Apollo.QueryHookOptions<GetFoodCoursesQuery, GetFoodCoursesQueryVariables>,
) {
  const options = {...defaultOptions, ...baseOptions}
  return Apollo.useQuery<GetFoodCoursesQuery, GetFoodCoursesQueryVariables>(
    GetFoodCoursesDocument,
    options,
  )
}
export function useGetFoodCoursesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetFoodCoursesQuery, GetFoodCoursesQueryVariables>,
) {
  const options = {...defaultOptions, ...baseOptions}
  return Apollo.useLazyQuery<GetFoodCoursesQuery, GetFoodCoursesQueryVariables>(
    GetFoodCoursesDocument,
    options,
  )
}
...
export type GetFoodCoursesQueryResult = Apollo.QueryResult<
  GetFoodCoursesQuery,
  GetFoodCoursesQueryVariables
>
...
export type CreateRecipeMutationOptions = Apollo.BaseMutationOptions<
  ...
  CreateRecipeMutationVariables
>
export const CreateBbcRecipeDocument = gql`
...
`
export type CreateBbcRecipeMutationFn = Apollo.MutationFunction<
  CreateBbcRecipeMutation,
  CreateBbcRecipeMutationVariables
>

/**
 * __useCreateBbcRecipeMutation__
 *
 * To run a mutation, you first call `useCreateBbcRecipeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateBbcRecipeMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createBbcRecipeMutation, { data, loading, error }] = useCreateBbcRecipeMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateBbcRecipeMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CreateBbcRecipeMutation,
    CreateBbcRecipeMutationVariables
  >,
  ...
  const options = {...defaultOptions, ...baseOptions}
  return Apollo.useMutation<CreateBbcRecipeMutation, CreateBbcRecipeMutationVariables>(
    CreateBbcRecipeDocument,
    options,
  )
}
export type CreateBbcRecipeMutationHookResult = ReturnType<typeof useCreateBbcRecipeMutation>
export type CreateBbcRecipeMutationResult = Apollo.MutationResult<CreateBbcRecipeMutation>
export type CreateBbcRecipeMutationOptions = Apollo.BaseMutationOptions<
  CreateBbcRecipeMutation,
  CreateBbcRecipeMutationVariables
>
