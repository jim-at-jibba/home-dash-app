...
export type RecipeDetails = {
  ...
  receipeNotes: Scalars['String'];
  receipeUrl: Scalars['String'];
  createdAt: Scalars['DateTime'];
  updatedAt: Scalars['DateTime'];
};
...
export type RecipeFull = {
  ...
  recipeNotes?: Maybe<Scalars['String']>;
  createdAt: Scalars['DateTime'];
  updatedAt: Scalars['DateTime'];
};
...
export type GetRecipeByIdQuery = (
  ...
  & { getRecipeById: (
    { __typename?: 'RecipeFull' }
    & Pick<RecipeFull, 'id' | 'name' | 'course' | 'categories' | 'description' | 'image' | 'cookTime' | 'prepTime' | 'serves' | 'recipeNotes' | 'recipeUrl'>
    & { steps: Array<(
      { __typename?: 'RecipeSteps' }
      & Pick<RecipeSteps, 'id' | 'stepNumber' | 'stepDescription'>
    )>, ingredients: Array<(
...
export type CreateRecipeMutation = (
  ...
  & { createRecipe: (
    { __typename?: 'RecipeFull' }
    & Pick<RecipeFull, 'id' | 'name' | 'course' | 'categories' | 'description' | 'image' | 'cookTime' | 'prepTime' | 'serves'>
    & { ingredients: Array<(
      { __typename?: 'RecipeIngredients' }
      & Pick<RecipeIngredients, 'id' | 'ingredient'>
    )>, steps: Array<(
...
export type CreateBbcRecipeMutation = (
  { __typename?: 'Mutation' }
  & { createRecipeFromBBC: (
    { __typename?: 'CreateRecipeOutput' }
    & Pick<CreateRecipeOutput, 'id'>
  ) }
);
...
export const CreateBbcRecipeDocument = gql`
  ...
  createRecipeFromBBC(input: $input) {
    ...
    `;
export type CreateBbcRecipeMutationFn = Apollo.MutationFunction<CreateBbcRecipeMutation, CreateBbcRecipeMutationVariables>;
 ...
 * });
 */
export function useCreateBbcRecipeMutation(baseOptions?: Apollo.MutationHookOptions<CreateBbcRecipeMutation, CreateBbcRecipeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateBbcRecipeMutation, CreateBbcRecipeMutationVariables>(CreateBbcRecipeDocument, options);
      }
...
export type CreateBbcRecipeMutationOptions = Apollo.BaseMutationOptions<CreateBbcRecipeMutation, CreateBbcRecipeMutationVariables>;
